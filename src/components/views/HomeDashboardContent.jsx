        ...
        <div className="h-full flex flex-col justify-center animate-[fadeIn_0.5s_ease-out] py-10">
            ...
            <div className="max-w-7xl mx-auto w-full px-4">
                ...
                <div className="mb-12 text-center">
                    <h1 className="text-3xl md:text-4xl font-bold text-textPrimary dark:text-white mb-2"></h1>
                    <p className="text-base md:text-lg text-textSecondary dark:text-darkTextSecondary"></p>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-y-10 gap-x-4 justify-items-center">
                    ...
                    {MASTER_APPS_DATA.map(app => (
                        <button 
                            key={app.id}
                            onClick={() => { navigateTo(app.id); notify('info', app.label, 'Opening Module...'); }} 
                            className="group flex flex-col items-center gap-3 w-full max-w-[100px] transition-transform duration-300 hover:-translate-y-2 active:scale-95"
                        >
