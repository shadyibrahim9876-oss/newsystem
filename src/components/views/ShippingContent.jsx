...
import * as Icons from '../icons/CustomIcons'; // استيراد الأيقونات
            ...
            <div className="mb-16 flex items-center relative">
                <div className="text-left">
                    ...
                    <p className="text-lg text-textSecondary dark:text-darkTextSecondary font-sans">
                        {step === 1 ? 'Select delivery scope' : step === 2 ? `Select mode for ${selectedType === 'local' ? 'Domestic' : 'International'}` : `Finalizing ${selectedMethod} for ${selectedType}`}
                    </p>
                </div>
            </div>
            ...
            {step === 2 && (
                <div className="grid grid-cols-3 gap-16 justify-items-start mt-16 max-w-3xl pl-4">
                    <button onClick={() => handleMethodSelect('Sea Freight')} className="group flex flex-col items-center gap-4 w-40 transition-transform duration-300 hover:-translate-y-1">
                        <div className="w-24 h-24 flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300"><Icons.SeaIcon /></div>
                        <div className="text-center"><span className="block text-xl font-bold text-textPrimary dark:text-white group-hover:text-cyan-400 transition-colors">Sea Freight</span><span className="text-sm text-textSecondary dark:text-darkTextSecondary font-sans">Ocean Transport</span></div>
                    </button>
                    <button onClick={() => handleMethodSelect('Air Freight')} className="group flex flex-col items-center gap-4 w-40 transition-transform duration-300 hover:-translate-y-1">
                        <div className="w-24 h-24 flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300"><Icons.AirIcon /></div>
                        <div className="text-center"><span className="block text-xl font-bold text-textPrimary dark:text-white group-hover:text-purple-400 transition-colors">Air Freight</span><span className="text-sm text-textSecondary dark:text-darkTextSecondary font-sans">Express Delivery</span></div>
                    </button>
                    <button onClick={() => handleMethodSelect('Land Freight')} className="group flex flex-col items-center gap-4 w-40 transition-transform duration-300 hover:-translate-y-1">
                        <div className="w-24 h-24 flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300"><Icons.LandIcon /></div>
                        <div className="text-center"><span className="block text-xl font-bold text-textPrimary dark:text-white group-hover:text-yellow-400 transition-colors">Land Freight</span><span className="text-sm text-textSecondary dark:text-darkTextSecondary font-sans">Truck Transport</span></div>
                    </button>
                </div>
            )}
